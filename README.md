...
### 🖼️ **[→ Open the gallery: 113 plates and 7 sounds](https://nicoconvoz.github.io/diosyunalma/galeria/)** · **[🏛️ Enter the museum: 241 stops in plain language](https://nicoconvoz.github.io/diosyunalma/galeria/museo.html)**
...
The full record is in **[docs/FINDINGS.md](docs/FINDINGS.md)**: **267 numbered
findings** (279 entries counting the lettered sub-findings)
...
The laboratory today: **210 reproducible experiments** under `cmd/`, **113
plates** and **7 sounds**, **36 measurement techniques** catalogued for reuse,
and a **[241-piece museum](https://nicoconvoz.github.io/diosyunalma/galeria/museo.html)**
