...
### 🖼️ **[→ Open the gallery: 135 plates and 8 sounds](https://nicoconvoz.github.io/diosyunalma/galeria/)** · **[🏛️ Enter the museum: 263 stops in plain language](https://nicoconvoz.github.io/diosyunalma/galeria/museo.html)**
...
The full record is in **[docs/FINDINGS.md](docs/FINDINGS.md)**: **291 numbered
findings** (303 entries counting the lettered sub-findings)
...
The laboratory today: **232 reproducible experiments** under `cmd/`, **135
plates** and **8 sounds**, **36 measurement techniques** catalogued for reuse,
and a **[263-piece museum](https://nicoconvoz.github.io/diosyunalma/galeria/museo.html)**
