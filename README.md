...
### 🖼️ **[→ Open the gallery: 124 plates and 8 sounds](https://nicoconvoz.github.io/diosyunalma/galeria/)** · **[🏛️ Enter the museum: 252 stops in plain language](https://nicoconvoz.github.io/diosyunalma/galeria/museo.html)**
...
The full record is in **[docs/FINDINGS.md](docs/FINDINGS.md)**: **280 numbered
findings** (292 entries counting the lettered sub-findings)
...
The laboratory today: **221 reproducible experiments** under `cmd/`, **124
plates** and **8 sounds**, **36 measurement techniques** catalogued for reuse,
and a **[252-piece museum](https://nicoconvoz.github.io/diosyunalma/galeria/museo.html)**
