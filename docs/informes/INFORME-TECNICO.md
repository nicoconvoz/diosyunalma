...
resumen ejecutivo con doble registro), **[HALLAZGOS-ES.md](../registro/HALLAZGOS-ES.md)**
(el registro completo en español: método, marcador de bits, y el tablero
de los 117 con veredicto y fuerza de cada uno), y
[FINDINGS.md](../registro/FINDINGS.md) (el maestro en inglés, 246 KB, cada tabla y
cada corrección).*
...
*Cada número remite a su entrada completa en [FINDINGS.md](../registro/FINDINGS.md),
