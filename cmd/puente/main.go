...
var salas = []Sala{
	{"teoremas", "🏛️", "Los Teoremas", "la cereza de la torta: Astorga, DYN, Diosyunalma, el Río de Pozos y la Trinidad — cuatro teoremas y su derivado, con enunciado, prueba y auditoría, y vienen más"},
