...
var salas = []Sala{
	{"teoremas", "🏛️", "Los Teoremas", "la cereza de la torta: Astorga, DYN, Diosyunalma y el Río de Pozos — tres teoremas y su derivado, con enunciado, prueba y auditoría, y vienen más"},
